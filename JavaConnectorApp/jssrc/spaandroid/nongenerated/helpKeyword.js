    ...
    if (status == 400) {
        if (mysqlHelpKeywordData["opstatus"] == 0) {
            if (mysqlHelpKeywordData != null && mysqlHelpKeywordData != undefined && mysqlHelpKeywordData["helpKeyword"] != null && mysqlHelpKeywordData["helpKeyword"] != undefined) {
                ...
                if (channel === "tablet") frmKeywords.hbxFooterPage.setVisibility(true);
                else hbxFooterPage.setVisibility(true);
            ...
            gVisit = 1;
            if (channel === "tablet") frmKeywords.hbxFooterPage.setVisibility(false);
            else hbxFooterPage.setVisibility(false);
...
function paginationNext() {
    ...
    if (absPageno > absNoOfPages) {
        if (channel === "tablet") frmKeywords.imgRightfooter.src = "trans1.png";
        else hbxFooterPage.vbxRightFooter.hbxRightFooter.imgRightfooter.src = "trans1.png";
        gPageno = gPageno - 1;
        return;
    }
    gNoOfRows = gNoOfRows + 40;
    var absNoofRows = Math.abs(gNoOfRows);
    if (absPageno == absNoOfPages) if (channel === "tablet") frmKeywords.imgRightfooter.src = "trans1.png";
    else hbxFooterPage.vbxRightFooter.hbxRightFooter.imgRightfooter.src = "trans1.png";
    if (absPageno == 1) {
        if (channel === "tablet") frmKeywords.imgLeftfooter.src = "trans1.png";
        else hbxFooterPage.vbxLeftFooter.hbxLeftFooter.imgLeftfooter.src = "trans1.png";
    } else {
    ...
    for (var i = gFromRow; i < gNoOfRows; i++) {
        if (ghkData[i] != null && ghkData[i] != undefined) nextHelpKeywordData.push(ghkData[i]);
    }
...
function paginationPrevious() {
    ...
    if (absPageno == 1) if (channel === "tablet") {
    ...
    for (var i = gFromRow; i < gNoOfRows; i++) {
        if (ghkData[i] != null && ghkData[i] != undefined) preHelpKeywordData.push(ghkData[i]);
    }
