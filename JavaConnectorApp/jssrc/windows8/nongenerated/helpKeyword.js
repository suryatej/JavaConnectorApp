...
function paginationNext() {
    ...
    if (absPageno == absNoOfPages) hbxFooterPage.vbxRightFooter.hbxRightFooter.imgRightfooter.src = "trans1.png";
    if (absPageno == 1) hbxFooterPage.vbxLeftFooter.hbxLeftFooter.imgLeftfooter.src = "trans1.png";
    else gFromRow = gFromRow + 8;
    alert("gPageno : " + gPageno.toPrecision());
